...
<head>
    ...
    <script src="/site/js/ie.js"></script>
</head>
...
<body>
    ...
    <figure>
        <video src="/site/img/visual.mp4" autoplay muted loop></video>
        <div class="inner">
            <h1>INNOVATION</h1>
    ...
    <section>
        <div class="inner">
            ...
            <div class="wrap">
                <article>
                    <div class="pic">
                        <img src="/site/img/news1.jpg" alt="1번째 콘텐츠 이미지">
                    </div>
                ...
                <article>
                    <div class="pic">
                        <img src="/site/img/news2.jpg" alt="2번째 콘텐츠 이미지">
                    </div>
                    <h2><a href="#">Lorem ipsum dolor sit.</a></h2>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vitae minus, eaque corrupti vero ad
                        maiores!</p>
                ...
                <article>
                    <div class="pic">
                        <img src="/site/img/news3.jpg" alt="3번째 콘텐츠 이미지">
                    </div>
                    <h2><a href="#">Lorem ipsum dolor sit.</a></h2>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vitae minus, eaque corrupti vero ad
                        maiores!</p>
                ...
                <article>
                    <div class="pic">
                        <img src="/site/img/news4.jpg" alt="4번째 콘텐츠 이미지">
                    </div>
                    <h2><a href="#">Lorem ipsum dolor sit.</a></h2>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vitae minus, eaque corrupti vero ad
                        maiores!</p>
